...
export function EditableField({
  ...
  if (!editing) {
    return (
      <div
        className={cn(
          "flex min-h-9 cursor-pointer items-center [overflow-wrap:anywhere] rounded px-1 -mx-1 border border-transparent transition-colors hover:border-border hover:bg-accent/50 md:block lg:min-h-0",
