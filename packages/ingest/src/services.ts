...
type WorkRecord = Pick<Work, "description" | "enrichmentStatus" | "id" | "language" | "seriesId" | "sortTitle" | "titleCanonical" | "titleDisplay">;
...
export interface IngestDb {
  ...
  work: {
    ...
    update(args: { where: { id: string }; data: Partial<Pick<Work, "description" | "enrichmentStatus" | "language" | "seriesId" | "sortTitle" | "titleCanonical" | "titleDisplay">> }): Promise<WorkRecord>;
  };
  edition: {
...
function createDefaultIngestDb(): IngestDb {
  ...
  return {
    ...
    work: {
      ...
      async update(args: { where: { id: string }; data: Partial<Pick<Work, "description" | "enrichmentStatus" | "language" | "seriesId" | "sortTitle" | "titleCanonical" | "titleDisplay">> }) {
