...
describe("health route", () => {
  it("loader calls both server functions in parallel and returns combined data", async () => {
    const mockHealth = { totalWorks: 50, checks: { missingCover: { count: 0, total: 50 }, noIsbn: { count: 0, total: 50 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 50 } } };
    ...
    expect(result).toEqual({ health: mockHealth, orphanedFiles: mockOrphans });
  });
  ...
  describe("HealthPage component", () => {
    ...
    it("does NOT render a Review link for Missing Covers", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 5, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
    ...
    it("does NOT render a Review link for Missing ISBN", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 10, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
      const links = screen.queryAllByRole("link");
    ...
    it("renders a link to /duplicates when there are pending duplicates", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 3 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
    ...
    it("renders a link to /match-suggestions when there are pending matches", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 4 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
      const links = screen.getAllByRole("link");
    ...
    it("renders orphaned file paths in the list", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 2 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [
          { id: "f1", relativePath: "books/orphan1.epub", mediaKind: "EPUB" as MediaKind, sizeBytes: 1024n },
          { id: "f2", relativePath: "books/orphan2.epub", mediaKind: "EPUB" as MediaKind, sizeBytes: 2048n },
        ],
    ...
    it("calls deleteOrphanedFileServerFn and invalidates on delete click", async () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 1 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [
    ...
    it("shows no orphaned files message when list is empty", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
    ...
    it("shows empty state when library has no works", () => {
      mockLoaderData = {
        health: { totalWorks: 0, checks: { missingCover: { count: 0, total: 0 }, noIsbn: { count: 0, total: 0 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 0 } } },
        orphanedFiles: [],
      };
      render(<Page />);
    ...
    it("shows singular 'issue' when exactly 1 issue found", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 1, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
    ...
    it("does not render review links for zero-count categories", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 0, total: 100 }, noIsbn: { count: 0, total: 100 }, pendingDuplicates: { count: 1 }, orphanedFiles: { count: 0 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
    ...
    it("calculates health score and renders it in data-testid element", () => {
      mockLoaderData = {
        health: { totalWorks: 100, checks: { missingCover: { count: 10, total: 100 }, noIsbn: { count: 20, total: 100 }, pendingDuplicates: { count: 0 }, orphanedFiles: { count: 5 }, pendingMatchSuggestions: { count: 0 }, staleEnrichment: { count: 0, total: 100 } } },
        orphanedFiles: [],
      };
      render(<Page />);
