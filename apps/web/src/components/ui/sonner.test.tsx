...
vi.mock("sonner", () => ({
  Toaster: ({ theme, className: _className, icons: _icons, style: _style, ...props }: { theme?: string; className?: string; icons?: unknown; style?: React.CSSProperties; [key: string]: unknown }) => (
